...
public class profile_administration3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 뒤로가기 눌렀을 때 profile_administration으로 화면 이동
        ImageButton imagebutton = findViewById(R.id.btnLoginBack);
        imagebutton.setOnClickListener(view -> {
            Intent intent = new Intent(profile_administration3Activity.this, profile_administrationActivity.class);
        ...
        button.setOnClickListener(view -> {
            Intent intent = new Intent(profile_administration3Activity.this, MyPageActivity.class);
            startActivity(intent);
        });
