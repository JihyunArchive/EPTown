...
public class order_pay6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(order_pay6Activity.this, order_details3Activity.class);
        ...
        textview.setOnClickListener(view -> {
            Intent intent = new Intent(order_pay6Activity.this, inquire6Activity.class);
            startActivity(intent);
        });
