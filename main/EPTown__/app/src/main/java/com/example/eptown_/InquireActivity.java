...
public class InquireActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inquire); // 레이아웃 설정
        ...
        registrationButtonColor.setOnClickListener(view -> {
            Intent intent = new Intent(InquireActivity.this, InquireAddActivity.class);
        ...
        button1.setOnClickListener(view -> {
            Intent intent = new Intent(InquireActivity.this, ItemDetailsInquiry.class);
            startActivity(intent);
        });
