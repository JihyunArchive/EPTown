...
public class JoinMembershipDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.join_membership_detail); // layout 파일 설정
        ...
        joinButton.setOnClickListener(view -> {
            Intent intent = new Intent(JoinMembershipDetailActivity.this, LoginActivity.class);
