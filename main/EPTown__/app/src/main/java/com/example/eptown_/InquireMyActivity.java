...
public class InquireMyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inquire_my);

        // 문의하기 텍스트 클릭시 inquire5로 화면 이동
        TextView textview = findViewById(R.id.writeReview);
        textview.setOnClickListener(view -> {
            Intent intent = new Intent(InquireMyActivity.this, InquireChoiceActivity.class);
