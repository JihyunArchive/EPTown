...
public class login1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnContinueColorButton.setOnClickListener(v -> {
            // 이메일 유효성 검사
    ...
    private void updateButtonState() {
        ...
        btnContinueColorButton.setEnabled(isEnabled);
        btnContinueColorButton.setBackgroundColor(isEnabled ? Color.parseColor("#FFA500") : Color.WHITE);
    }
