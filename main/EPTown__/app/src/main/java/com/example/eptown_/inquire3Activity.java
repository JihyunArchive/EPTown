...
public class inquire3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagebutton2.setOnClickListener(view -> {
            Intent intent = new Intent(inquire3Activity.this, NoticeActivity.class);
            startActivity(intent);
        });
        ...
        imagebutton3.setOnClickListener(view -> {
            Intent intent = new Intent(inquire3Activity.this, CartActivity.class);
            startActivity(intent);
        });
        ...
        button.setOnClickListener(view -> {
            Intent intent = new Intent(inquire3Activity.this, coupon3Activity.class);
            startActivity(intent);
        });
