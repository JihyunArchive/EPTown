...
public class MypageNoLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MypageNoLoginActivity.this, LoginActivity.class);
        ...
        textview3.setOnClickListener(view -> {
            Intent intent = new Intent(MypageNoLoginActivity.this, HospitalActivity.class);
            startActivity(intent);
        });
        ...
        textview4.setOnClickListener(view -> {
            Intent intent = new Intent(MypageNoLoginActivity.this, CommunityActivity.class);
            startActivity(intent);
        });
        ...
        imagebutton2.setOnClickListener(view -> {
            Intent intent = new Intent(MypageNoLoginActivity.this, MainActivity.class);
            startActivity(intent);
        });
        ...
        imagebutton4.setOnClickListener(view -> {
            Intent intent = new Intent(MypageNoLoginActivity.this, CategoryMainActivity.class);
            startActivity(intent);
        });
